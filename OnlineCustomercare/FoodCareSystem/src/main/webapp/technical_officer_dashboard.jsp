...
<head>
    ...
    <title>Technical Officer Dashboard - Customer Care</title>
    <style>
        body {
    ...
    <script>
        function showSection(sectionId) {
            document.getElementById('pendingComplaints').classList.remove('active');
            document.getElementById('repliedComplaints').classList.remove('active');
...
<body>
    <!-- Navbar -->
    <div class="navbar">
        <a href="#" class="tab" onclick="showSection('pendingComplaints')">Pending Complaints</a>
        <a href="#" class="tab" onclick="showSection('repliedComplaints')">Replied Complaints</a>
    ...
    <br><br><br><br><br>
     <div class="content">
    <h1 style="color:white">Welcome, <%= username %>!</h1></div>

    <!-- Pending Complaints Section -->
    <div id="pendingComplaints" class="complaints-section active">
     <div class="content">
        <h2  style="color:white">Pending Complaints</h2>
        </div>
        <table>
            <tr>
                <th>Complaint ID</th>
    ...
    <div id="repliedComplaints" class="complaints-section">
    <div class="content">
        <h2 style="color:white">Replied Complaints</h2>
        </div>
        <table>
            <tr>
                <th>Complaint ID</th>
